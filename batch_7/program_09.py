# Prog09. index() return the first location of the function parameter in the string. Create a program that do the 
# same functionality without using index() function.
try:
